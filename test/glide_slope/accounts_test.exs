defmodule GlideSlope.AccountsTest do
  use GlideSlope.DataCase

  alias GlideSlope.Accounts

  import GlideSlope.AccountsFixtures
  alias GlideSlope.Accounts.{User, UserToken}
  ...
  describe "transactions" do
    ...
    test "create_transaction/1 with valid data creates a transaction" do
      valid_attrs = %{amount: "120.5", currency: "some currency", import_date: ~U[2022-02-04 19:00:00Z], text: "some text", transaction_date: ~U[2022-02-04 19:00:00Z]}
      ...
      assert transaction.import_date == ~U[2022-02-04 19:00:00Z]
      assert transaction.text == "some text"
      assert transaction.transaction_date == ~U[2022-02-04 19:00:00Z]
    end
    ...
    test "update_transaction/2 with valid data updates the transaction" do
      transaction = transaction_fixture()
      update_attrs = %{amount: "456.7", currency: "some updated currency", import_date: ~U[2022-02-05 19:00:00Z], text: "some updated text", transaction_date: ~U[2022-02-05 19:00:00Z]}
      ...
      assert transaction.import_date == ~U[2022-02-05 19:00:00Z]
      assert transaction.text == "some updated text"
      assert transaction.transaction_date == ~U[2022-02-05 19:00:00Z]
    end
